...
# DVE full session
# Saved on Wed Dec 5 21:15:47 2012
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/p5/session.inter.vpd.tcl" type="Debug">
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 172]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 171} {height 452} {dock_state left} {dock_on_new_line false} {child_hier_colhier 150} {child_hier_coltype 21} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 154} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 210} {child_wave_right 978} {child_wave_colname 140} {child_wave_colvalue 66} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { -ucligui} -dir ../p5 -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active top top.sv
...
gui_marker_move -id ${Wave.1} {C1} 87
gui_view_scroll -id ${Wave.1} -vertical -set 675
