...
# DVE full session
# Saved on Thu Dec 6 12:25:35 2012
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 170} {height 453} {dock_state left} {dock_on_new_line false} {child_hier_colhier 150} {child_hier_coltype 21} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 153} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_radix -radix {binary} -signals {Sim:top.host.S.bitStreamEncoder5.crc5.out}
gui_set_radix -radix {unsigned} -signals {Sim:top.host.S.bitStreamEncoder5.crc5.out}
...
gui_marker_create -id ${Wave.1} M2 278
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 1774 1799
...
gui_list_select -id ${Wave.1} {top.host.S.bitStreamEncoder5.crc5.out }
