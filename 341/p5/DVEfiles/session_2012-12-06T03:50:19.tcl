...
# DVE full session
# Saved on Thu Dec 6 03:50:19 2012
# Designs open: 1
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/p5/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 30} {1287 719}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 171]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 451
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 170} {height 437} {dock_state left} {dock_on_new_line false} {child_hier_colhier 150} {child_hier_coltype 21} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 195} {child_wave_right 908} {child_wave_colname 140} {child_wave_colvalue 51} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ece.cmu.edu/usr/bflores/341/p5/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/p5/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341/p5 -nosource
}
}
...
set host host
gui_sg_create ${host}
gui_sg_addsignal -group ${host} { top.host.curr top.host.wires top.host.indicator top.host.endp top.host.ack top.host.data top.host.en_count top.host.receiverOK top.host.receive top.host.cl_count top.host.pid top.host.messageOK top.host.sendingRequest top.host.messageReceived top.host.clk top.host.nak top.host.rst_L top.host.receiverDone top.host.sentTimes top.host.count top.host.senderDone top.host.reading top.host.writing top.host.senderOn top.host.dataToSend }
set S S
gui_sg_create ${S}
...
catch {gui_list_select -id ${Hier.1} {top.host.S}}
...
gui_list_show_data -id ${Data.1} {top.host.S}
...
gui_marker_create -id ${Wave.1} START 84
gui_marker_set_ref -id ${Wave.1}  C1
gui_wv_zoom_timerange -id ${Wave.1} 710989 711011
gui_list_add_group -id ${Wave.1} -after {New Group} {host}
gui_list_add_group -id ${Wave.1} -after {New Group} {S}
gui_list_collapse -id ${Wave.1} S
gui_list_select -id ${Wave.1} {top.host.messageReceived }
...
gui_marker_move -id ${Wave.1} {C1} 3237690
