...
# DVE full session
# Saved on Wed Sep 5 19:52:52 2012
# Designs open: 1
#   Sim: /afs/ece.cmu.edu/usr/bflores/341/past_sem/hw1/work/simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/past_sem/hw1/work/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{3 52} {1278 1049}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 243]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 242} {height 723} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1275} {height 167} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 409} {child_data_colvalue 296} {child_data_coltype 324} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/past_sem/hw1/work/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341/past_sem/hw1/work -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active fsm_D /afs/ece.cmu.edu/usr/bflores/341/past_sem/hw1/work/../prob7.sv
