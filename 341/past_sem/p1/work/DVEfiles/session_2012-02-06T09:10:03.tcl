...
# DVE full session
# Saved on Mon Feb 6 09:10:02 2012
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 140} {height 249} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
set Wave.1 [gui_create_window -type Wave -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 285]
gui_set_window_pref_key -window ${Wave.1} -key dock_width -value_type integer -value 1220
gui_set_window_pref_key -window ${Wave.1} -key dock_height -value_type integer -value 285
gui_set_window_pref_key -window ${Wave.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Wave.1} {{left 0} {top 0} {width 1269} {height 284} {show_state normal} {dock_state bottom} {dock_on_new_line true} {child_wave_left 364} {child_wave_right 876} {child_wave_colname 218} {child_wave_colvalue 144} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 424} {child_data_colvalue 356} {child_data_coltype 343} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_sg_addsignal -group ${Group1} { {top.calc.keyIn} {top.calc.in} {top.calc.display} {top.calc.ld_input} {top.calc.rst_b} {top.calc.clk} {top.calc.error} {top.calc.push} {top.calc.pop} {top.calc.empty} {top.calc.two_num} {top.calc.load} {top.calc.ld_alu_1} {top.calc.ld_alu_2} {top.calc.clr_alu} {top.calc.ld_result} {top.calc.up_counter} {top.calc.en_counter} {top.calc.clr_counter} {top.calc.ld_counter} {top.calc.clr_op} {top.calc.ld_op} {top.calc.sel_add} {top.calc.negate} {top.calc.overflow} {top.calc.sel_1} {top.calc.sel_2} {top.calc.sel_3} {top.calc.op_out} {top.calc.count} {top.calc.new_value} {top.calc.out_alu_1} {top.calc.out_alu_2} {top.calc.out_result} {top.calc.mux1_out} {top.calc.mux3_out} {top.calc.stack_out} {top.calc.reg0_in} {top.calc.reg1_in} {top.calc.reg2_in} {top.calc.reg3_in} {top.calc.reg4_in} {top.calc.reg5_in} {top.calc.reg6_in} {top.calc.reg7_in} {top.calc.reg0_out} {top.calc.reg1_out} {top.calc.reg2_out} {top.calc.reg3_out} {top.calc.reg4_out} {top.calc.reg5_out} {top.calc.reg6_out} {top.calc.reg7_out} }
...
gui_list_select -id ${Wave.1} {top.calc.display }
gui_list_set_insertion_bar  -id ${Wave.1} -group {Group1} -item {top.calc.display[7:0]} -position below
