...
void  rmaPropagate0wn(UB  * pcode, scalar  val);
...
void  rmaPropagate1wn(UB  * pcode, scalar  val);
...
void  rmaPropagate11wn(UB  * pcode, scalar  val);
...
void  rmaPropagate12wn(UB  * pcode, scalar  val);
...
void  rmaPropagate13wn(UB  * pcode, scalar  val);
...
void  rmaPropagate14wn(UB  * pcode, scalar  val);
...
void  rmaPropagate15wn(UB  * pcode, scalar  val);
