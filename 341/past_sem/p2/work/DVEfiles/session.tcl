...
# DVE full session
# Saved on Thu Mar 8 12:35:45 2012
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 52} {1286 1052}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 246]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 731
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 245} {height 731} {show_state normal} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1278} {height 170} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active top /afs/ece.cmu.edu/usr/bflores/341/p2/work/../top.sv
