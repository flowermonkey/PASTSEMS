...
# DVE full session
# Saved on Wed Mar 7 16:59:06 2012
# Designs open: 1
...
#   Wave.8: 26 signals
#   Wave.9: 26 signals
#   Source.1: top.genblk1[1].router_inst
#   Wave.1: 25 signals
#   Wave.2: 19 signals
#   Group count = 9
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 22} {1279 1023}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 247]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 906
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 246} {height 731} {show_state normal} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1279} {height 171} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 409} {child_data_colvalue 296} {child_data_coltype 324} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
set Source.1 [gui_create_window -type {Source}  -parent ${TopLevel.1}]
gui_show_window -window ${Source.1} -show_state maximized
gui_update_layout -id ${Source.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false}}
set Wave.1 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.1} -show_state maximized
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.2 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.2} -show_state maximized
gui_update_layout -id ${Wave.2} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.3 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.3} -show_state maximized
gui_update_layout -id ${Wave.3} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.4 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.4} -show_state maximized
gui_update_layout -id ${Wave.4} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.5 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.5} -show_state maximized
gui_update_layout -id ${Wave.5} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.6 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.6} -show_state maximized
gui_update_layout -id ${Wave.6} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.7 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.7} -show_state maximized
gui_update_layout -id ${Wave.7} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.8 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.8} -show_state maximized
gui_update_layout -id ${Wave.8} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
set Wave.9 [gui_create_window -type {Wave}  -parent ${TopLevel.1}]
gui_show_window -window ${Wave.9} -show_state maximized
gui_update_layout -id ${Wave.9} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 301} {child_wave_right 726} {child_wave_colname 176} {child_wave_colvalue 121} {child_wave_col1 0} {child_wave_col2 1}}
...
# Global: Breakpoints
gui_sim_watch { -file {/afs/ece/usr/bflores/341/p2/work/../router.sv}  -line {61}    }
gui_sim_watch { -file {/afs/ece/usr/bflores/341/p2/work/../router.sv}  -line {123}    }
...
gui_sg_addsignal -group ${Router 0} { {top.genblk1[0].router_inst.clk} {top.genblk1[0].router_inst.rst_b} {top.genblk1[0].router_inst.free_outbound} {top.genblk1[0].router_inst.put_outbound} {top.genblk1[0].router_inst.payload_outbound} {top.genblk1[0].router_inst.free_inbound} {top.genblk1[0].router_inst.put_inbound} {top.genblk1[0].router_inst.payload_inbound} {top.genblk1[0].router_inst.rr_ld} {top.genblk1[0].router_inst.rm} {top.genblk1[0].router_inst.sr_en} {top.genblk1[0].router_inst.sent} {top.genblk1[0].router_inst.loc} {top.genblk1[0].router_inst.data} {top.genblk1[0].router_inst.found} {top.genblk1[0].router_inst.port} {top.genblk1[0].router_inst.st} {top.genblk1[0].router_inst.ns} {top.genblk1[0].router_inst.ROUTERID} }
...
catch {gui_list_select -id ${Hier.1} {{top.genblk1[0].router_inst}}}
...
gui_list_show_data -id ${Data.1} {top.genblk1[0].router_inst}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {{top.genblk1[0].router_inst.st} {top.genblk1[0].router_inst.sent} {top.genblk1[0].router_inst.put_outbound} {top.genblk1[0].router_inst.ns} {top.genblk1[0].router_inst.found} {top.genblk1[0].router_inst.data} {top.genblk1[0].router_inst.payload_outbound} {top.genblk1[0].router_inst.rm} {top.genblk1[0].router_inst.payload_inbound} {top.genblk1[0].router_inst.loc} {top.genblk1[0].router_inst.port} {top.genblk1[0].router_inst.rst_b} {top.genblk1[0].router_inst.put_inbound} {top.genblk1[0].router_inst.free_inbound} {top.genblk1[0].router_inst.clk} {top.genblk1[0].router_inst.free_outbound} {top.genblk1[0].router_inst.rr_ld} {top.genblk1[0].router_inst.sr_en} {top.genblk1[0].router_inst.ROUTERID} }}
...
gui_open_source -id ${Source.1}  -replace -active {top.genblk1[1].router_inst} /afs/ece.cmu.edu/usr/bflores/341/p2/work/../router.sv
...
gui_wv_zoom_timerange -id ${Wave.2} 0 577
...
gui_list_expand -id ${Wave.2} {top.genblk1[0].router_inst.payload_inbound}
gui_list_expand -id ${Wave.2} {top.genblk1[0].router_inst.rm}
gui_list_expand -id ${Wave.2} {top.genblk1[0].router_inst.loc}
gui_list_expand -id ${Wave.2} {top.genblk1[0].router_inst.data}
gui_list_select -id ${Wave.2} {{top.genblk1[0].router_inst.rm[2]} }
...
gui_marker_move -id ${Wave.2} {C1} 320
gui_view_scroll -id ${Wave.2} -vertical -set 303
...
gui_wv_zoom_timerange -id ${Wave.3} 122 358
...
gui_list_expand -id ${Wave.3} {top.genblk1[1].router_inst.data}
...
gui_marker_move -id ${Wave.3} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.4} 122 358
...
gui_marker_move -id ${Wave.4} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.5} 122 358
...
gui_list_set_insertion_bar  -id ${Wave.5} -group {Node 1}  -position in
...
gui_marker_move -id ${Wave.5} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.6} 122 358
...
gui_marker_move -id ${Wave.6} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.7} 122 358
...
gui_marker_move -id ${Wave.7} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.8} 122 358
...
gui_marker_move -id ${Wave.8} {C1} 320
...
gui_wv_zoom_timerange -id ${Wave.9} 122 358
...
gui_marker_move -id ${Wave.9} {C1} 320
