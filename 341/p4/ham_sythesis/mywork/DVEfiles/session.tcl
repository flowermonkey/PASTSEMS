...
# DVE full session
# Saved on Wed Nov 14 13:03:21 2012
# Designs open: 1
#   Sim: /afs/ece.cmu.edu/usr/bflores/341/p4/ham_sythesis/mywork/simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/p4/ham_sythesis/mywork/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{33 60} {1299 825}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 196]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 195} {height 489} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/p4/ham_sythesis/mywork/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341/p4/ham_sythesis/mywork -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active top /afs/ece.cmu.edu/usr/bflores/341/p4/ham_sythesis/mywork/../ham.sv
