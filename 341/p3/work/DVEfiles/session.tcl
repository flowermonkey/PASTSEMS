...
# DVE full session
# Saved on Tue Oct 30 12:45:20 2012
# Designs open: 1
#   Sim: /afs/ece.cmu.edu/usr/bflores/341/p3/work/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: top.brokenCalc
#   Group count = 1
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/p3/work/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{9 52} {1278 1003}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 199]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 674
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 198} {height 674} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1269} {height 170} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 421} {child_data_colvalue 303} {child_data_coltype 327} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ece.cmu.edu/usr/bflores/341/p3/work/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/p3/work/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341/p3/work -nosource
}
}
...
gui_sg_addsignal -group ${Group1} { top.result top.stackOverflow top.inputQ_size top.ck top.protocolError top.data {top.unnamed$$_15} top.intA top.intB top.intC top.intD top.intE top.intF top.unexpectedDone top.dataOverflow top.rst_l top.test_indicator top.finished top.specialCase top.correct }
...
catch { gui_list_select -id ${Data.1} {{top.unnamed$$_15} }}
gui_view_scroll -id ${Data.1} -vertical -set 151
...
gui_open_source -id ${Source.1}  -replace -active top.brokenCalc /afs/ece.cmu.edu/usr/bflores/341/p3/work/../TA_calc_correct.sv.e
