...
# DVE full session
# Saved on Sun Sep 9 06:43:21 2012
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{3 52} {1278 823}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 233]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 507
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 232} {height 507} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1275} {height 157} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ece.cmu.edu/usr/bflores/341/p1/work/simv}
...
gui_wv_zoom_timerange -id ${Wave.1} 1112 1320
...
gui_marker_move -id ${Wave.1} {C1} 1215
...
set origGroupCreationState [gui_list_create_group_when_add -wave]
gui_list_create_group_when_add -wave -disable
gui_marker_create -id ${Wave.2} C2 835
gui_marker_set_ref -id ${Wave.2}  C1
gui_wv_zoom_timerange -id ${Wave.2} 427 1215
gui_list_add_group -id ${Wave.2} -after {New Group} {Group1}
gui_list_select -id ${Wave.2} {tb_pq.pq.count }
...
gui_marker_move -id ${Wave.2} {C1} 1215
