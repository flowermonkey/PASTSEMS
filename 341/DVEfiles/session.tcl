...
# DVE full session
# Saved on Thu Dec 13 01:32:20 2012
# Designs open: 1
#   Sim: /afs/ece.cmu.edu/usr/bflores/341/simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-7 30} {1357 734}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 170]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 453
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 169} {height 453} {dock_state left} {dock_on_new_line false} {child_hier_colhier 150} {child_hier_coltype 21} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1364} {height 152} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341 -nosource
}
}
...
gui_load_child_values {top.t}

set Group1 Group1
gui_sg_create ${Group1}
gui_sg_addsignal -group ${Group1} { top.t.state top.t.clk top.t.i top.t.count }
...
catch {gui_list_select -id ${Hier.1} {top.t}}
...
gui_list_show_data -id ${Data.1} {top.t}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {top.t.state top.t.clk top.t.i top.t.count }}
...
gui_open_source -id ${Source.1}  -replace -active top /afs/ece.cmu.edu/usr/bflores/341/test.sv
...
gui_wv_zoom_timerange -id ${Wave.1} 0 319
...
gui_marker_move -id ${Wave.1} {C1} 84
