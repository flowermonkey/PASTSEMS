...
# DVE full session
# Saved on Tue Oct 9 06:45:39 2012
# Designs open: 1
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 220]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 436
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 219} {height 437} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
catch {gui_list_expand -id ${Hier.1} {top.genblk1[1].router_inst}}
catch {gui_list_select -id ${Hier.1} {{top.genblk1[1].router_inst.B1[3].input_buf}}}
gui_view_scroll -id ${Hier.1} -vertical -set 147
...
gui_list_show_data -id ${Data.1} {top.genblk1[1].router_inst.B1[3].input_buf}
