...
# DVE full session
# Saved on Sat Oct 6 01:35:24 2012
# Designs open: 1
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/bflores/341/hw1/work/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-8 30} {1909 1206}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line false -dock_extent 222]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 221} {height 906} {dock_state left} {dock_on_new_line false} {child_hier_colhier 200} {child_hier_coltype 48} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1917} {height 171} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 493} {child_wave_right 1197} {child_wave_colname 288} {child_wave_colvalue 202} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMEXE {/afs/ece.cmu.edu/usr/bflores/341/hw1/work/simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/bflores/341/hw1/work/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/bflores/341/hw1/work -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 189
...
gui_marker_move -id ${Wave.2} {C1} 170
